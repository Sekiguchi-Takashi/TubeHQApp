...
object Yokoku {
    ...
    fun draw(c: Canvas, s: Shot, w: Int, h: Int) {
    ...
    private fun tag(c: Canvas, p: Paint, s: Shot, h: Int) {
        val left = 52f
        val top = 58f
        val w = 196f
        val bh = 74f
    ...
    private fun title(c: Canvas, p: Paint, s: Shot, w: Int, h: Int) {
    ...
    private fun sub(c: Canvas, p: Paint, s: Shot, w: Int, h: Int) {
        val body = s.sub.trim()
        if (body.isEmpty()) return
